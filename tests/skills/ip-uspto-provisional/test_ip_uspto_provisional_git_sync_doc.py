...
# The 5 write-bearing ip-uspto-provisional commands per the issue #436 curation
# inventory. The portfolio orchestrator (ip-uspto-provisional.md) is read-only and
