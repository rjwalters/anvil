# Fixtures: pub rubric version transition (issue #357, mirrors #346)
...
`pub` skill in issue #357 (the /40 → /44 migration with dim 9
*Rhetorical economy*):
...
These fixtures are consumed by `test_pub_rubric_version_transition_doc.py`
...
fields → score_history" + `anvil/skills/pub/commands/pub-review.md`
