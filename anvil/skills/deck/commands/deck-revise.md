...
11. **Write `_revision-log.md`** at `<thread>.{N+1}/_revision-log.md`:
    ...
    |---|---|---|---|
    | acme-seed.1.review | `refs/cv.pdf` "Foundry Trust, 2013-2023" | `refs/cv.pdf` actually reads "Foundry Trust, 2018-2023" | Slide 10 written with the verified 5-year tenure, not the finding's 10-year claim. |
