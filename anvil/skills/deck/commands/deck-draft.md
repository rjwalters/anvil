...
- **Explain before you name.** Per `anvil/lib/snippets/plain_language.md` §"The 7-point framework" (issue #1042), a claim or mechanism should be stated in plain language before it leans on a term of art — an investor reading fast should never need the jargon to follow the argument. This is a Dim 9 (Rhetorical economy) concern owned by `deck-narrative`, not a reason to add slides: the plain-language restatement belongs in the same beat as the term, not a new one.
