...
SRC_PEER = Path("refs") / "foundry.latest" / "exhibits" / "headline.csv"

# Avoid this — silently goes stale the next time `foundry` is revised:
SRC_PEER = Path("refs") / "foundry.8" / "exhibits" / "headline.csv"
```
