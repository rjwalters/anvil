...
4. **Per-dimension scorecard**: markdown table `# | Dimension | Weight | Score | Justification` — all 9 rows present, non-owned dimensions score `null`, justification `n/a — see <owning critic>`.
