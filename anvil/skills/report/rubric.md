...
The reviewer and auditor should each raise a flag for any other issue that, in their judgment, meets the standard above — these ten examples are starting points, not a closed set.
