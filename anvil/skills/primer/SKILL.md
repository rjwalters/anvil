...
- **The Botho "Botho from the Basics" worked example** under `examples/` — dogfood once the shape lands (Botho #881, the motivating downstream consumer). No vendored example ships in v1.
