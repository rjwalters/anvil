# Revision plan — `northwind-pitch.4`

| Field | Value |
|---|---|
| Thread | `northwind-pitch` |
| Source version | `northwind-pitch.3/` |
| Target version | `northwind-pitch.4/` |
...
|---|---|---|---|---|---|---|
| 1 | `northwind-pitch.3.review (critical)` | critical | §3.2 ¶2 | Pericles.2 economics sketch with inline-cited numbers | +80 | +1 dim 3 |
| 2 | `northwind-pitch.3.review (major)` | major | §1–§5 | Inline citation pass | +120 | +1 dim 3 <!-- declined: pulls voice away from "clean and forceful presentation" -->
| 3 | `northwind-pitch.3.review (major)` | major | §5 risks (new #6) | Sphere exec/funding risk paragraph | +90 | +1 dim 6 |
| 5 | `northwind-pitch.3.review (nit)` | declined | §3↔§4 | Reorder Recommendation before Market [declined: scope-drift; defer to v5] | 0 | +1 dim 8 |
