...
# smart-actuators — project BRIEF (parser fixture)

This fixture pins the typed-parser contract shipped under issue #285
(sub-deliverable 2 of #283). It mirrors the smart-actuators
...
exercise the parser primitive, not to ship real smart-actuators
content.
