...
``tests/fixtures/skeleton_derivation/praetor_word_soup/`` preserves the Studio
canary worked example (the praetor memo.5 that scored 43/44 yet failed to
...
class TestPraetorCanaryFindings(unittest.TestCase):
    """The fixture encodes the Studio canary failure mode verbatim.

    The praetor memo.5 catch is the worked-example anchor for the derivation
