...
def _interpret_source_item(
    ...
    The three observed shapes (beacon / geode / the-atelier) all flow
...
def _render_stub(entry: BriefSourceEntry) -> str:
    ...
    Schema (confirmed against the-atelier / beacon / foundry / geode
    on-disk exemplars):
