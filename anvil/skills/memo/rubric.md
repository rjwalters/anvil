...
- **Literal-path cites**: `<thread-slug>/memo.<N>/memo.md` (e.g., `meridian-synthesis/memo.2/memo.md`).
- **Short-form cites**: `<thread-slug> §X` or `<thread-slug>/memo §X` (e.g., `meridian-synthesis §3.1`, `meridian-synthesis/memo §3.1`).
- **Relative-path cites** (the studio convention): `output/<thread-slug>/...` (e.g., `output/meridian-synthesis/memo.2/memo.md`).
- **Backtick-wrapped cites**: `` `<thread-slug>/memo.<N>/memo.md` §<X> `` (e.g., `` `meridian-synthesis/memo.2/memo.md` §5.2 ``).
