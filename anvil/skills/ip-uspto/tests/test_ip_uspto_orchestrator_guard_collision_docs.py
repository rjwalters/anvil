...
Every ip-uspto command doc whose critic writes a sidecar-manifest file
...
repo-wide, including the nine ip-uspto sidecar-writing critic docs below —
...
# The ip-uspto command docs whose critic writes findings.md (or a sibling
