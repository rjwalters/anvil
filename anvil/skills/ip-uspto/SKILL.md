...
- **Out of scope** (split to a follow-up): the §112(a) disclosure-coverage check (did the converted subject matter exceed what the provisional enabled). This linkage is mechanical — date + boilerplate — only.
