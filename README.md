...
**Status:** v0.11.3. Installable — see the Skills table below for the current list. Actively developed against a real-world canary consumer ([2AM Logic Studio](https://2amlogic.com)) — the framework is sharpened by being used, not by being designed in isolation.
